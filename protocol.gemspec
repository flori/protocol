...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc", "lib/protocol.rb", "lib/protocol/core.rb", "lib/protocol/method_parser/parse_tree.rb", "lib/protocol/method_parser/ruby_parser.rb", "lib/protocol/version.rb"]
  s.files = [".gitignore", "CHANGES", "COPYING", "Gemfile", "README.rdoc", "Rakefile", "VERSION", "benchmarks/data/.keep", "benchmarks/data/MethodParserBenchmark#nocache-autocorrelation.dat", "benchmarks/data/MethodParserBenchmark#nocache-slopes.dat", "benchmarks/data/MethodParserBenchmark#nocache.dat", "benchmarks/data/MethodParserBenchmark#standard-autocorrelation.dat", "benchmarks/data/MethodParserBenchmark#standard-slopes.dat", "benchmarks/data/MethodParserBenchmark#standard.dat", "benchmarks/method_parser.rb", "examples/assignments.rb", "examples/comparing.rb", "examples/enumerating.rb", "examples/game.rb", "examples/hello_world_patternitis.rb", "examples/indexing.rb", "examples/locking.rb", "examples/queue.rb", "examples/stack.rb", "install.rb", "lib/protocol.rb", "lib/protocol/core.rb", "lib/protocol/method_parser/parse_tree.rb", "lib/protocol/method_parser/ruby_parser.rb", "lib/protocol/version.rb", "protocol.gemspec", "tests/test_protocol.rb", "tests/test_protocol_method_parser.rb"]
